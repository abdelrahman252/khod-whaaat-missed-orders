...
const _STRINGS = {
  en: {
    ...
    "dashboard.loading_body": "Loading dashboard...",
    ...
    "preloader.dashboard.stage.accounts.body": "Matching accounts, currencies, and the selected date range.",
    "preloader.dashboard.stage.metrics.label": "Metrics",
    "preloader.dashboard.stage.metrics.body": "Preparing orders, sales, COD, commission, and NDR metrics.",
    ...
    "titlebar.close": "Close KHOD WHAAT Bot",
    ...
    "setup.country_hint": "KHOD WHAAT currently supports Saudi Arabia only.",
    ...
    "welcome.app_title":      "KHOD WHAAT Bot",
    ...
    "welcome.autoconfirm_title": "🤖 Auto-Confirm",
    "welcome.autoconfirm_desc": "When off, review and edit orders before submitting.",
    "welcome.affiliate_recovery_title": "🔁 Affiliate Recovery",
    "welcome.affiliate_recovery_desc": "Resend real orders and convert missed orders to affiliates.",
    ...
    "run.phase4":         "Upload Orders to EasyOrders",
    "run.waiting":        "Waiting...",
    ...
    "run.creating":       "📤 Uploading Orders to EasyOrders",
    ...
    "run.preview_cols":   ["Product", "Qty", "Price", "Date", "EasyOrders Created", "City", "Name", "Phone"],
    ...
    "results.failed":     "Failed on EasyOrders",
    ...
    "results.total":      "Total",
    "results.fail_title": (n) => `${n} Order${n > 1 ? "s" : ""} Failed to Upload`,
    ...
    "setup.static_hint":        "This account uses Excel Static Update and does not connect to KHOD WHAAT or EasyOrders.",
    ...
    "results.order_sources":      "Upload Summary",
    ...
    "dashboard.fetching_body":     "Fetching live KHOD WHAAT orders and refreshing saved dashboard data. This can take a few minutes; keep the app open.",
    ...
    "analytics.uploadedUpdate.none": "No uploaded orders found in the selected range.",
    "analytics.uploadedUpdate.loadingTitle": "Updating uploaded orders...",
    "analytics.uploadedUpdate.loadingBody": "Fetching latest KHOD WHAAT statuses for uploaded orders in the selected range.",
    "analytics.uploadedUpdate.loadingShort": "Updating...",
    "analytics.uploadedUpdate.account": "Updating uploaded orders {current} of {total}: {account}",
    "analytics.uploadedUpdate.errorTitle": "Uploaded orders update failed",
    "analytics.uploadedUpdate.errorBody": "Uploaded orders update failed.",
    "analytics.uploadedUpdate.partialTitle": "Uploaded orders partially updated",
    "analytics.uploadedUpdate.partialBody": "Updated {count} uploaded orders from {success} of {total} account(s). Some accounts failed.",
    "analytics.uploadedUpdate.successTitle": "Uploaded orders updated",
    "analytics.uploadedUpdate.successBody": "Updated {count} uploaded orders. Status and revenue refreshed.",
    "analytics.uploadedUpdate.noChanges": "Uploaded orders are already up to date.",
    // license page
    ...
    "license.restore_body":       "Restore your saved KHOD WHAAT/EasyOrders credentials on this device. Orders and local reports stay local to each machine.",
    ...
    "expired.btn_support":        "Contact Support",
    "expired.meta_merchant":      "Merchant Name",
    "expired.meta_license_id":    "License ID",
    "expired.copy_license":       "Copy license ID",
    "expired.copied_license":     "License ID copied",
    "expired.copy_failed":        "Could not copy the license ID.",
  ...
  ar: {
    ...
    "dashboard.loading_body": "جاري تحميل لوحة التحكم...",
    ...
    "preloader.dashboard.stage.accounts.body": "جارٍ مطابقة الحسابات والعملات ونطاق التاريخ المحدد.",
    "preloader.dashboard.stage.metrics.label": "المؤشرات",
    "preloader.dashboard.stage.metrics.body": "جارٍ تجهيز الطلبات والمبيعات والتحصيل والعمولة ومؤشر NDR.",
    "preloader.dashboard.stage.modules.label": "عروض لوحة التحكم",
    "preloader.dashboard.stage.modules.body": "جارٍ بناء عروض المنتجات والمدن والحملات والحاسبة والملخص.",
    ...
    "titlebar.close": "إغلاق KHOD WHAAT Bot",
    ...
    "welcome.autoconfirm_title": "🤖 التأكيد التلقائي",
    "welcome.autoconfirm_desc": "عند الإيقاف، راجع وعدّل الطلبات قبل إرسالها.",
    "welcome.affiliate_recovery_title": "🔁 استرداد الأفلييت",
    "welcome.affiliate_recovery_desc": "إعادة إرسال الطلبات وتحويل الطلبات الفائتة للأفلييت.",
    ...
    "run.phase3":         "تسجيل دخول KHOD WHAAT والتصدير",
    "run.phase4":         "رفع الطلبات إلى EasyOrders",
    ...
    "run.creating":       "📤 رفع الطلبات إلى EasyOrders",
    ...
    "run.preview_cols":   ["المنتج", "الكمية", "السعر", "التاريخ", "تاريخ EasyOrders", "المدينة", "الاسم", "الهاتف"],
    ...
    "results.failed":     "فشل الرفع إلى EasyOrders",
    ...
    "results.fail_title": (n) => `${n} طلب فشل رفعه`,
    ...
    "setup.static_hint":        "\u064a\u0633\u062a\u062e\u062f\u0645 \u0647\u0630\u0627 \u0627\u0644\u062d\u0633\u0627\u0628 \u0627\u0644\u062a\u062d\u062f\u064a\u062b \u0627\u0644\u062b\u0627\u0628\u062a \u0628\u0645\u0644\u0641 Excel \u0648\u0644\u0627 \u064a\u062a\u0635\u0644 \u0628\u0640 KHOD WHAAT \u0623\u0648 EasyOrders.",
    ...
    "results.order_sources":      "ملخص الرفع",
    ...
    "run.notif_error_title":      "KHOD WHAAT Bot - خطأ",
    ...
    "dashboard.fetching_body":     "يتم جلب طلبات KHOD WHAAT الحية وتحديث بيانات لوحة التحكم المحفوظة. اترك التطبيق مفتوحا.",
    ...
    "analytics.uploadedUpdate.none": "لم يتم العثور على طلبات مرفوعة في النطاق المحدد.",
    "analytics.uploadedUpdate.loadingTitle": "جاري تحديث الطلبات المرفوعة...",
    "analytics.uploadedUpdate.loadingBody": "يتم جلب أحدث حالات KHOD WHAAT للطلبات المرفوعة في النطاق المحدد.",
    "analytics.uploadedUpdate.loadingShort": "جاري التحديث...",
    "analytics.uploadedUpdate.account": "تحديث الطلبات المرفوعة {current} من {total}: {account}",
    "analytics.uploadedUpdate.errorTitle": "فشل تحديث الطلبات المرفوعة",
    "analytics.uploadedUpdate.errorBody": "فشل تحديث الطلبات المرفوعة.",
    "analytics.uploadedUpdate.partialTitle": "تم تحديث الطلبات المرفوعة جزئيا",
    "analytics.uploadedUpdate.partialBody": "تم تحديث {count} طلب مرفوع من {success} من أصل {total} حساب. فشلت بعض الحسابات.",
    "analytics.uploadedUpdate.successTitle": "تم تحديث الطلبات المرفوعة",
    "analytics.uploadedUpdate.successBody": "تم تحديث {count} طلب مرفوع. تم تحديث الحالة والإيراد.",
    "analytics.uploadedUpdate.noChanges": "الطلبات المرفوعة محدثة بالفعل.",
    // license page
    ...
    "expired.btn_support":        "تواصل مع الدعم",
    "expired.meta_merchant":      "اسم التاجر",
    "expired.meta_license_id":    "معرّف الترخيص",
    "expired.copy_license":       "نسخ معرّف الترخيص",
    "expired.copied_license":     "تم نسخ معرّف الترخيص",
    "expired.copy_failed":        "تعذّر نسخ معرّف الترخيص.",
...
window.KhodUI = (() => {
  ...
  function toast(message, options = {}) {
    ...
    item.className = `khod-toast khod-toast-${kind}${options.variant === "admin" ? " khod-toast-admin" : ""}`;
    item.innerHTML = `
      <div class="khod-toast-dot" aria-hidden="true"></div>
      <div class="khod-toast-content">
        ${options.title ? `<div class="khod-toast-title">${esc(options.title)}</div>` : ""}
    ...
    if (!options.persistent) setTimeout(close, options.timeout || 4200);
    return close;
  }
...
// Shared dashboard modules still use the historical Taager UI contract.
// Point it at the KHOD implementation so those modules remain functional
// without changing the KHOD-specific renderer identity.
window.TaagerUI = window.KhodUI;
...
window.KhodCountry = (() => {
  ...
  function flagClass(value) {
    return `khod-country-flag flag:${get(value).code}`;
  }
...
// Hydrated dashboard sections still use the Taager-era public name. Keep both
// names pinned to the same country service so they cannot drift.
window.TaagerCountry = window.KhodCountry;

window.KhodCurrency = (() => {
  const STORAGE_KEY = "khod_currency_rates_v1";
  const LEGACY_STORAGE_KEY = "taager_currency_rates_v1";
  ...
  function format(value, currency, opts) {
    ...
    const country = opts.country || (window.KhodCountry && window.KhodCountry.fromCurrency ? window.KhodCountry.fromCurrency(cur) : "sa");
    const locale = opts.locale || (window.dashboardI18n && window.dashboardI18n.locale && window.dashboardI18n.locale()) || (window.KhodCountry && window.KhodCountry.locale ? window.KhodCountry.locale(country) : "en-US");
  ...
  function countryCurrency(country) {
    return window.KhodCountry && window.KhodCountry.currency ? window.KhodCountry.currency(country) : "SAR";
  }
...
// Dashboard bundles still use the Taager-era currency public name. Keep it
// pinned to KHOD's service so live refreshes, conversions, and manual rates all
// share one cache and one source-of-truth.
window.TaagerCurrency = window.KhodCurrency;
...
window.KhodGeo = (() => {
  ...
  function atlasData() {
    return window.KhodCountryAtlas || {};
  }
    ...
    for (let pass = 0; pass < Number(opts.iterations || 28); pass++) {
      for (let i = 0; i < points.length; i++) {
        for (let j = i + 1; j < points.length; j++) {
          ...
          const nx = dx / dist;
          const ny = dy / dist;
          const lockExact = opts.preserveExact === true;
          const aLocked = lockExact && (a.exact === true || a.exactPoint === true);
          const bLocked = lockExact && (b.exact === true || b.exactPoint === true);
      ...
      points.forEach((point) => {
        if (opts.preserveExact === true && (point.exact === true || point.exactPoint === true)) {
...
// Cities and COD are hydrated independently and call the compatibility name.
// Publishing the shared engine here ensures both surfaces use the same atlas,
// exact city anchors, province centers, and spread behavior.
window.TaagerGeo = window.KhodGeo;

// ── Theme & Lang helpers ──
let _languageRefreshToken = 0;
let _themePaintToken = 0;

function afterNextPaint(callback) {
  const raf = window.requestAnimationFrame || ((fn) => window.setTimeout(fn, 0));
  raf(() => raf(callback));
}
const runAfterBrowserPaint = afterNextPaint;
window.KhodAfterNextPaint = afterNextPaint;
window.TaagerAfterNextPaint = afterNextPaint;
window.TaagerDashboardMotionDisabled = true;
window.TaagerDashboardMotionDisabledCheck = () => window.TaagerDashboardMotionDisabled !== false;
...
function waitForStableUi(options) {
  ...
  const fontsReady = window.khodFontsReady && typeof window.khodFontsReady.then === "function"
    ? window.khodFontsReady.catch(() => false)
  ...
  return fontsReady
    ...
    .then(() => new Promise((resolve) => {
      ...
      window.setTimeout(() => frame().then(resolve), Math.min(quietMs, remaining || quietMs));
    }));
}
window.KhodWaitForStableUi = waitForStableUi;
...
window.KhodBeginUiStabilization = beginUiStabilization;
window.KhodEndUiStabilization = endUiStabilization;
window.TaagerBeginUiStabilization = beginUiStabilization;
window.TaagerEndUiStabilization = endUiStabilization;
window.TaagerIsUiStabilizing = () => _uiStabilizationLocks.size > 0 || document.documentElement.classList.contains("taager-ui-stabilizing");

function applyTheme(theme) {
  const paintToken = ++_themePaintToken;
  ...
  runAfterBrowserPaint(() => {
    window.setTimeout(() => {
      if (paintToken === _themePaintToken) {
...
function applyLang(lang) {
  const refreshToken = ++_languageRefreshToken;
  ...
  runAfterBrowserPaint(() => {
    if (refreshToken !== _languageRefreshToken || window._kbotLang !== lang) return;
    updateTopBarText();
    ...
    reRenderCurrentPage(refreshToken);
  });
}
...
const FEATURE_SCRIPT_GROUPS = {
  analytics: [
    ...
    "pages/khod-product-names.js",
    "pages/khod-status.js",
  ...
  dashboard: [
    ...
    "pages/dashboard/dashboard-financial-core.js",
    "pages/dashboard/dashboard-khod-logic-core.js",
  ...
  dashboardCharts: ["pages/analytics/chart.umd.min.js"],
  dashboardProducts: ["pages/dashboard/sections/section5-products.js"],
  dashboardProductsHydrated: [
    "pages/smart-insights-core.js",
    "pages/dashboard/dashboard-financial-core.js",
    "pages/dashboard/sections/section5-products-hydrated.js",
  ],
  dashboardCampaigns: ["pages/dashboard/sections/section-campaigns.js"],
  ...
  dashboardDailyPerformance: ["pages/dashboard/sections/section-daily-performance.js"],
  ...
  dashboardCod: ["pages/dashboard/sections/section4-cod.js"],
  ...
  dashboardCities: ["pages/dashboard/sections/section-cities.js"],
  ...
  dashboardForecastHydrated: [
    "pages/smart-insights-core.js",
    "pages/dashboard/dashboard-financial-core.js",
    "pages/dashboard/sections/section9-product-forecast-hydrated.js",
  ],
  dashboardGmvTarget: ["pages/dashboard/sections/section-gmv-target.js"],
  // Static Update parses workbooks in the main process through IPC. Loading
  // the 900KB browser XLSX bundle here delayed the section by several seconds
  // without being used by its renderer.
  dashboardStaticUpdate: ["pages/dashboard/sections/section-static-update.js"],
  dashboardAiSection: [
    "pages/ai-intelligence/ai-intelligence-data.js",
...
async function ensureFeatureScripts(feature) {
  const traceTimer = window.DashboardTrace
    ? window.DashboardTrace.start(feature, "bundle:ensure", {
        styles: (FEATURE_STYLE_GROUPS[feature] || []).length,
        scripts: (FEATURE_SCRIPT_GROUPS[feature] || []).length
      })
    : null;
  const perfTimer = KhodPerf.start("feature:" + feature + ":ensure", {
    feature,
    styles: (FEATURE_STYLE_GROUPS[feature] || []).length,
    scripts: (FEATURE_SCRIPT_GROUPS[feature] || []).length
  });
  ...
  try {
    ...
    await stylePromise;
    keepVisualSystemLast();
    KhodPerf.end(perfTimer, { ok: true });
    if (traceTimer) window.DashboardTrace.end(traceTimer, { ok: true });
  } catch (err) {
    KhodPerf.end(perfTimer, { ok: false, error: err && err.message ? err.message : String(err || "") });
    if (traceTimer) window.DashboardTrace.end(traceTimer, { ok: false, error: err && err.message ? err.message : String(err || "") });
    throw err;
  }
}
...
window.ensureDashboardSection = function ensureDashboardSection(sectionId) {
  if (sectionId === "taagerAi") sectionId = "khodAi";
...
window.preloadDashboardSectionResources = function preloadDashboardSectionResources() {
  // The assistant's reasoning stack is intentionally loaded after the user
  // submits a question. Preloading it here competes with every normal section
  // and made late dashboard navigation progressively slower.
  DASHBOARD_INTERACTIVE_FEATURES
    .filter((feature) => feature !== "dashboardAiSection")
    .forEach(preloadFeatureResources);
};

let _dashboardCriticalPrewarmPromise = null;
window.prewarmDashboardCriticalSections = function prewarmDashboardCriticalSections() {
  if (_dashboardCriticalPrewarmPromise) return _dashboardCriticalPrewarmPromise;
  // Execute only the costly, frequently opened sections after the first
  // dashboard paint. This removes their first-click hydration preloader
  // without competing with startup by executing every dashboard feature.
  _dashboardCriticalPrewarmPromise = Promise.all([
    ensureFeatureScripts("dashboardOrders"),
    ensureFeatureScripts("dashboardCampaigns"),
    ensureFeatureScripts("dashboardCod"),
    ensureFeatureScripts("dashboardProducts")
  ]).then(() => Promise.all([
    ensureFeatureScripts("dashboardOrdersHydrated"),
    ensureFeatureScripts("dashboardCampaignsHydrated"),
    ensureFeatureScripts("dashboardCodHydrated"),
    ensureFeatureScripts("dashboardProductsHydrated")
  ])).catch((error) => {
    _dashboardCriticalPrewarmPromise = null;
    console.warn("[Dashboard] Critical section prewarm failed:", error?.message || error);
  });
  return _dashboardCriticalPrewarmPromise;
};

let _dashboardPreparePromise = null;
window.prepareDashboardSections = function prepareDashboardSections() {
  if (_dashboardPreparePromise) return _dashboardPreparePromise;
  window.preloadDashboardSectionResources();
  const readyFeatures = DASHBOARD_INTERACTIVE_FEATURES.filter((feature) =>
    feature !== "dashboardAi" && feature !== "dashboardAiSection" && feature !== "dashboardStaticUpdate"
  );
  _dashboardPreparePromise = Promise.all(readyFeatures.map((feature) =>
    ensureFeatureScripts(feature).then(() => ({ feature, ok: true })).catch((error) => {
      console.warn("[Dashboard] Section preparation failed:", feature, error?.message || error);
  ...
  return _dashboardPreparePromise;
};

window.KhodDashboardEagerPrewarm = false;
window.prewarmDashboardSections = function prewarmDashboardSections() {
  if (window.KhodDashboardEagerPrewarm !== true) return;
  if (_dashboardSectionPrewarmStarted) return;
  _dashboardSectionPrewarmStarted = true;
  const queue = DASHBOARD_INTERACTIVE_FEATURES.slice();
  const scheduleNext = () => {
    if (!queue.length) return;
    const run = (deadline) => {
      if (!isActivePage("page-dashboard")) return;
      const phase = window.__khodPerfLastPhase;
      const inputPending = navigator.scheduling &&
        typeof navigator.scheduling.isInputPending === "function" &&
        navigator.scheduling.isInputPending();
      if (inputPending || (phase && phase.state === "running") ||
...
const APP_RELOAD_RESTORE_KEY = "khod-app-reload-restore-v1";
const LEGACY_APP_RELOAD_RESTORE_KEY = "taager-app-reload-restore-v1";
...
function consumeAppReloadRestoreState() {
  let parsed = null;
  try {
    parsed = JSON.parse(sessionStorage.getItem(APP_RELOAD_RESTORE_KEY) || sessionStorage.getItem(LEGACY_APP_RELOAD_RESTORE_KEY) || "null");
    sessionStorage.removeItem(APP_RELOAD_RESTORE_KEY);
    sessionStorage.removeItem(LEGACY_APP_RELOAD_RESTORE_KEY);
  } catch (_) {
    try { sessionStorage.removeItem(APP_RELOAD_RESTORE_KEY); } catch (__) {}
    try { sessionStorage.removeItem(LEGACY_APP_RELOAD_RESTORE_KEY); } catch (__) {}
    return null;
  }
...
function activatePage(pageId) {
  ...
  state.active = true;
  const page = document.getElementById(pageId);
  if (page && typeof page._khodActivate === "function") page._khodActivate();
}
...
function deactivatePage(pageId) {
  ...
  state.active = false;
  const page = document.getElementById(pageId);
  if (page && typeof page._khodDeactivate === "function") page._khodDeactivate();
}

window.KhodPageLifecycle = {
...
const KhodPerf = (() => {
  ...
  function enabled() {
    try {
      return window.__KHOD_PERF_DIAGNOSTICS === true ||
        window.__TAAGER_PERF_DIAGNOSTICS === true ||
        localStorage.getItem("khod-perf") === "1" ||
        localStorage.getItem("taager-perf") === "1" ||
        /(?:\?|&)(?:khodPerf|taagerPerf)=1\b/.test(window.location.search || "");
    } catch (_) {
      return window.__KHOD_PERF_DIAGNOSTICS === true || window.__TAAGER_PERF_DIAGNOSTICS === true;
    }
  }
  ...
  function push(entry) {
    ...
    if (enabled() && next.type === "measure") {
      console.debug("[KhodPerf]", next.name, Math.round(next.durationMs * 10) / 10 + "ms", next.detail || "");
    }
    return next;
  }
  ...
  function dump(filter) {
    ...
    else console.log("[KhodPerf]", list);
    return list;
  }
  ...
  function snapshot(label) {
    ...
    if (enabled()) console.debug("[KhodPerf] stability snapshot", snap);
    return snap;
  }
  ...
  async function runDashboardSectionStabilityCheck(sequence, rounds) {
    ...
    const afterSwitchPaint = () => Promise.resolve();
    const settleLazyPanes = () => new Promise((resolve) => setTimeout(resolve, 1200));
    const deactivateHiddenPanes = () => {
      const container = document.getElementById("dash-section-pane");
      if (!container) return;
      const activePane = mount._dashboardActivePane || null;
      Array.from(container.children).forEach((pane) => {
        ...
        if (typeof pane._dashboardSectionDeactivate === "function") {
          try { pane._dashboardSectionDeactivate(); } catch (err) { console.error("[Dashboard] Hidden pane deactivate failed:", err); }
        }
        if (pane._dashboardSectionLifecycle && pane._dashboardLifecycleActive && typeof pane._dashboardSectionLifecycle.deactivate === "function") {
          try { pane._dashboardSectionLifecycle.deactivate(pane); } catch (err) { console.error("[Dashboard] Hidden pane lifecycle deactivate failed:", err); }
        }
        pane._dashboardLifecycleActive = false;
        pane.hidden = true;
        pane.setAttribute("aria-hidden", "true");
        if ("inert" in pane) pane.inert = true;
      });
    };
        ...
        list.getEntries().forEach((entry) => {
          push({
            ...
            detail: {
              activeRoute: window.__khodActiveRoute || "",
              activeSection: (document.getElementById("db-shell-mount") || {})._dashboardActiveSection || "",
              lastSectionPhase: window.__khodPerfLastPhase || null
            }
          });
        });
      });
  ...
  const api = {
    ...
    enableLogs: () => {
      try { localStorage.setItem("khod-perf", "1"); } catch (_) {}
      window.__KHOD_PERF_DIAGNOSTICS = true;
      window.__TAAGER_PERF_DIAGNOSTICS = true;
    },
    disableLogs: () => {
      try {
        localStorage.removeItem("khod-perf");
        localStorage.removeItem("taager-perf");
      } catch (_) {}
      window.__KHOD_PERF_DIAGNOSTICS = false;
...
// Human-readable dashboard flight recorder. Every section, query and
// background task uses the same bounded, searchable console timeline.
const DashboardTrace = (() => {
  ...
  const cleanSection = (section) => String(section || "dashboard").replace(/^dashboard[-:]/, "");

  function emit(section, event, detail, level) {
    ...
    entries.push(item);
    if (entries.length > MAX_ENTRIES) entries.splice(0, entries.length - MAX_ENTRIES);
    const prefix = `[DashboardTrace #${String(item.seq).padStart(4, "0")}][${item.section}][${item.event}]`;
    const method = level === "warn" ? "warn" : level === "error" ? "error" : "info";
    if (window.console && typeof window.console[method] === "function") window.console[method](prefix, item.detail);
    return item;
  }

  function start(section, event, detail) {
    const id = `${cleanSection(section)}:${event}:${Date.now().toString(36)}:${Math.random().toString(36).slice(2, 6)}`;
    open.set(id, { section: cleanSection(section), event, startedAt: now(), detail: detail || {} });
    emit(section, `${event}:start`, detail);
    return id;
  }

  function end(id, detail) {
    const timer = open.get(id);
    if (!timer) return null;
    open.delete(id);
    const durationMs = Math.round((now() - timer.startedAt) * 10) / 10;
    const merged = Object.assign({}, timer.detail, detail || {}, { durationMs });
    emit(timer.section, `${timer.event}:end`, merged, durationMs >= 100 ? "warn" : "info");
    return durationMs;
  }

  function renderStart(section, detail) {
    const key = cleanSection(section) + "|" + String(detail && detail.renderKey || "");
    renderCounts[key] = (renderCounts[key] || 0) + 1;
    const count = renderCounts[key];
    if (count > 1) emit(section, "render:repeat", Object.assign({}, detail || {}, { count }), "warn");
    return start(section, "render", Object.assign({}, detail || {}, { count }));
  }

  function summary() {
    const grouped = {};
    entries.forEach((entry) => {
      const key = `${entry.section} :: ${entry.event}`;
      if (!grouped[key]) grouped[key] = { section: entry.section, event: entry.event, count: 0, maxDurationMs: 0 };
      grouped[key].count += 1;
      grouped[key].maxDurationMs = Math.max(grouped[key].maxDurationMs, Number(entry.detail && entry.detail.durationMs || 0));
    });
    const rows = Object.keys(grouped).map((key) => grouped[key]).sort((a, b) => b.maxDurationMs - a.maxDurationMs || b.count - a.count);
  ...
  const api = {
    ...
    entries: () => entries.slice(),
    dump: (section) => {
      const key = section ? cleanSection(section) : "";
      const rows = entries.filter((entry) => !key || entry.section === key);
      if (console.table) console.table(rows);
      return rows;
    },
    summary,
    copy: (section) => JSON.stringify(section ? entries.filter((entry) => entry.section === cleanSection(section)) : entries, null, 2),
    clear: () => { entries.splice(0, entries.length); open.clear(); Object.keys(renderCounts).forEach((key) => delete renderCounts[key]); },
    enable: () => { active = true; emit("dashboard", "trace:enabled", { maxEntries: MAX_ENTRIES }); },
    disable: () => { emit("dashboard", "trace:disabled", {}); active = false; },
    isEnabled: () => active
  };
  window.DashboardTrace = api;
  emit("dashboard", "trace:ready", { maxEntries: MAX_ENTRIES, hint: "DashboardTrace.summary() / DashboardTrace.dump('cod')" });
  return api;
})();

function perfMark(name, detail) {
  KhodPerf.mark(name, detail);
}

function featureLoadingShell(title, body) {
  const esc = window.KhodUI && window.KhodUI.esc
    ? window.KhodUI.esc
  ...
  return `
    <div class="sv3-shell route-loading-shell">
      <div class="route-loading-panel" role="status" aria-live="polite">
        <span class="khod-spinner" aria-hidden="true"></span>
        <div>
  ...
  el.innerHTML = `
    <div class="sv3-shell route-loading-shell">
      <div class="route-loading-panel route-loading-panel-error" role="alert">
        <div class="khod-state-icon" aria-hidden="true">!</div>
        <div>
          <strong>${esc(title)}</strong>
          <span>${esc(msg)}</span>
        </div>
...
function dismissPreloader() {
  ...
  waitForStableUi({ quietMs: 120, maxWaitMs: 1800 }).catch(() => {}).then(() => {
...
window.KhodPreloader = (() => {
  const stages = [
    { id: "engine", start: 0, end: 14, labelKey: "preloader.dashboard.stage.engine.label", label: "Dashboard engine", bodyKey: "preloader.dashboard.stage.engine.body", body: "Loading dashboard code, styles, and controls.", activity: "Starting dashboard..." },
    { id: "snapshot", start: 14, end: 30, labelKey: "preloader.dashboard.stage.snapshot.label", label: "Saved snapshots", bodyKey: "preloader.dashboard.stage.snapshot.body", body: "Reading saved account snapshots from this device.", activity: "Loading saved dashboard snapshot" },
    { id: "accounts", start: 30, end: 44, labelKey: "preloader.dashboard.stage.accounts.label", label: "Accounts", bodyKey: "preloader.dashboard.stage.accounts.body", body: "Matching accounts, currencies, and the selected date range.", activity: "Resolving account scope" },
    { id: "metrics", start: 44, end: 66, labelKey: "preloader.dashboard.stage.metrics.label", label: "Metrics", bodyKey: "preloader.dashboard.stage.metrics.body", body: "Preparing orders, sales, COD, commission, and NDR metrics.", activity: "Calculating dashboard metrics" },
    { id: "modules", start: 66, end: 80, labelKey: "preloader.dashboard.stage.modules.label", label: "Dashboard views", bodyKey: "preloader.dashboard.stage.modules.body", body: "Building product, city, campaign, calculator, and master views.", activity: "Preparing dashboard modules" },
    { id: "marketing", start: 80, end: 91, labelKey: "preloader.dashboard.stage.marketing.label", label: "Marketing spend", bodyKey: "preloader.dashboard.stage.marketing.body", body: "Checking connected marketing spend for the selected range.", activity: "Checking marketing connections" },
    { id: "rendering", start: 91, end: 98, labelKey: "preloader.dashboard.stage.rendering.label", label: "Rendering", bodyKey: "preloader.dashboard.stage.rendering.body", body: "Rendering the final dashboard view.", activity: "Rendering dashboard content" },
  ];
  const stageIndex = new Map(stages.map((stage, index) => [stage.id, index]));
  const state = {
    currentStage: "engine",
    percent: 6,
    activity: "Preparing dashboard loader",
    activityKey: "loader.activity.preparing",
    activityParams: null,
    complete: false,
    stagePercents: Object.fromEntries(stages.map((stage) => [stage.id, 0])),
  };
  let smoothTimers = [];
  let smoothCompletionResolve = null;
  let motionTimer = null;
  let motionTarget = 6;

  function clampPercent(value, complete) {
    const number = Number(value);
    if (!Number.isFinite(number)) return state.percent;
    const max = complete ? 100 : 98;
  ...
  function dashboardText(key, params, fallback) {
    if (key && window._t) {
      const value = window._t(key);
      const translated = typeof value === "function" ? value(params) : value;
      if (translated && translated !== key) return translated;
    }
    if (key && window.dashboardI18n && typeof window.dashboardI18n.t === "function") {
      const translated = window.dashboardI18n.t(key, params);
      if (translated && translated !== key) return translated;
    }
    return fallback || key || "";
  }
  ...
  function normalizeActivityInput(input) {
    if (typeof input === "string") return { activity: input };
    return input || {};
  }

  function setActivityState(input, fallbackKey, fallbackText) {
    const options = normalizeActivityInput(input);
    state.activityKey = options.activityKey || fallbackKey || "";
    state.activityParams = options.activityParams || null;
    state.activity = options.activity || fallbackText || "";
  }

  function activityText() {
    if (window._kbotLang === "ar" && !state.activityKey) {
      const activityMap = {
        "Starting dashboard...": "\u062c\u0627\u0631\u064d \u0628\u062f\u0621 \u0644\u0648\u062d\u0629 \u0627\u0644\u062a\u062d\u0643\u0645...",
        "Loading saved snapshot payload": "\u062c\u0627\u0631\u064d \u062a\u062d\u0645\u064a\u0644 \u0628\u064a\u0627\u0646\u0627\u062a \u0627\u0644\u0644\u0642\u0637\u0629 \u0627\u0644\u0645\u062d\u0641\u0648\u0638\u0629",
        "Reading saved dashboard snapshots": "\u062c\u0627\u0631\u064d \u0642\u0631\u0627\u0621\u0629 \u0644\u0642\u0637\u0627\u062a \u0644\u0648\u062d\u0629 \u0627\u0644\u062a\u062d\u0643\u0645 \u0627\u0644\u0645\u062d\u0641\u0648\u0638\u0629",
        "No saved account snapshot yet": "\u0644\u0627 \u062a\u0648\u062c\u062f \u0644\u0642\u0637\u0629 \u062d\u0633\u0627\u0628 \u0645\u062d\u0641\u0648\u0638\u0629 \u0628\u0639\u062f",
        "Preparing empty dashboard metrics": "\u062c\u0627\u0631\u064d \u062a\u062c\u0647\u064a\u0632 \u0645\u0624\u0634\u0631\u0627\u062a \u0644\u0648\u062d\u0629 \u062a\u062d\u0643\u0645 \u0641\u0627\u0631\u063a\u0629",
        "Dashboard views prepared": "\u062a\u0645 \u062a\u062c\u0647\u064a\u0632 \u0639\u0631\u0648\u0636 \u0644\u0648\u062d\u0629 \u0627\u0644\u062a\u062d\u0643\u0645",
        "Rendering final dashboard": "\u062c\u0627\u0631\u064d \u0639\u0631\u0636 \u0644\u0648\u062d\u0629 \u0627\u0644\u062a\u062d\u0643\u0645 \u0627\u0644\u0646\u0647\u0627\u0626\u064a\u0629"
      };
      if (activityMap[state.activity]) return activityMap[state.activity];
      let match = String(state.activity || "").match(/^(\d+) account snapshots loaded$/);
      if (match) return "\u062a\u0645 \u062a\u062d\u0645\u064a\u0644 " + match[1] + " \u0644\u0642\u0637\u0627\u062a \u062d\u0633\u0627\u0628";
      match = String(state.activity || "").match(/^(\d+) rows in selected period$/);
      if (match) return match[1] + " \u0635\u0641\u0648\u0641 \u0641\u064a \u0627\u0644\u0641\u062a\u0631\u0629 \u0627\u0644\u0645\u062d\u062f\u062f\u0629";
    }
    return dashboardText(state.activityKey, state.activityParams, state.activity);
  }

  function updateDom() {
    const root = getLoader();
    if (!root) return;
    root.classList.toggle("is-complete", !!state.complete);
    root.dataset.dashboardStage = state.currentStage || "";
    root.style.setProperty("--dashboard-loader-percent", state.percent + "%");
    root.setAttribute("data-dashboard-loader-stage", state.currentStage || "");

    setText(root, "[data-dashboard-percent-value]", state.percent + "%");
    setText(root, "[data-dashboard-activity]", activityText());
    setText(root, "[data-dashboard-loader-percent]", state.percent);
    setText(root, "[data-dashboard-loader-activity]", activityText());

    const activeStage = stages.find((stage) => stage.id === state.currentStage) || stages[0];
    setText(root, "[data-dashboard-loader-title]", dashboardText(activeStage.labelKey, null, activeStage.label));
    setText(root, "[data-dashboard-loader-body]", dashboardText(activeStage.bodyKey, null, activeStage.body));
    const ring = root.querySelector("[data-dashboard-loader-ring]");
    if (ring) ring.style.setProperty("--dashboard-loader-progress", (state.percent * 3.6) + "deg");
    const fill = root.querySelector("[data-dashboard-loader-fill]");
    ...
    const bar = root.querySelector("[data-dashboard-progress-bar]");
    if (bar) bar.style.width = state.percent + "%";

    stages.forEach((stage) => {
      const card = root.querySelector('[data-dashboard-stage-card="' + stage.id + '"]');
      const percentEl = root.querySelector('[data-dashboard-stage-percent="' + stage.id + '"]');
      const value = state.stagePercents[stage.id] || 0;
      if (card) {
        card.classList.toggle("is-active", state.currentStage === stage.id && !state.complete);
        card.classList.toggle("is-complete", state.complete || value >= 100);
      }
      if (percentEl) percentEl.textContent = Math.round(value) + "%";
    });

    const stagePanel = root.querySelector("[data-dashboard-loader-stages]");
    if (stagePanel) {
      const activeIndex = stageIndex.get(activeStage.id) || 0;
      stagePanel.innerHTML = stages.map((stage, index) => {
        const value = state.complete || index < activeIndex ? 100 : (index > activeIndex ? 0 : Math.max(1, Math.round(state.stagePercents[stage.id] || 1)));
        const cls = state.complete || index < activeIndex ? "is-done" : (index === activeIndex ? "is-active" : "");
        return '<div class="dashboard-loader-step ' + cls + '" data-dashboard-stage-card="' + stage.id + '">' +
          '<span class="dashboard-loader-step-dot" aria-hidden="true"></span>' +
          '<span class="dashboard-loader-step-label">' + dashboardText(stage.labelKey, null, stage.label) + '</span>' +
          '<span class="dashboard-loader-step-percent" data-dashboard-stage-percent="' + stage.id + '">' + value + '%</span>' +
        '</div>';
      }).join("");
    }
  }
  ...
  function startMotion() {
    if (motionTimer || !getLoader() || state.complete) return;
    motionTimer = setInterval(() => {
      if (!getLoader() || state.complete) {
        stopMotion();
        return;
      }
      if (motionTarget < 92) motionTarget = Math.min(92, motionTarget + 0.22);
      const delta = motionTarget - state.percent;
      if (delta > 0.12) {
        state.percent = clampPercent(state.percent + Math.max(0.18, delta * 0.14), false);
        const stage = stages.find((item) => item.id === state.currentStage) || stages[0];
        const span = Math.max(1, stage.end - stage.start);
        state.stagePercents[stage.id] = Math.min(99, Math.max(state.stagePercents[stage.id] || 0, ((state.percent - stage.start) / span) * 100));
        updateDom();
      }
    }, 280);
  }

  function clearSmoothCompletion() {
    smoothTimers.forEach((timer) => clearTimeout(timer));
    smoothTimers = [];
    if (smoothCompletionResolve) {
      const resolve = smoothCompletionResolve;
      smoothCompletionResolve = null;
      resolve();
    }
  }

  function reset(activity) {
    clearSmoothCompletion();
    stopMotion();
    state.currentStage = "engine";
    state.percent = 6;
    motionTarget = 6;
    setActivityState(activity, "preloader.dashboard.activity.starting", "Starting dashboard...");
    state.complete = false;
    stages.forEach((stage) => {
      state.stagePercents[stage.id] = 0;
    });
    updateDom();
    startMotion();
  }

  function applyComplete(options) {
    stopMotion();
    state.currentStage = "rendering";
    state.percent = 100;
    state.complete = true;
    setActivityState(options, options && options.error ? "preloader.dashboard.activity.bestData" : "preloader.dashboard.activity.ready", options && options.error ? "Dashboard opened with the best available data." : "Dashboard ready.");
    stages.forEach((stage) => {
      state.stagePercents[stage.id] = 100;
    });
    updateDom();
  }

  function smoothComplete(options) {
    clearSmoothCompletion();
    const checkpoints = [
      { stage: "accounts", percent: 32, activityKey: "loader.activity.accountsScope", activity: "Resolving dashboard account scope" },
      { stage: "metrics", percent: 58, activityKey: "loader.activity.metrics", activity: "Calculating dashboard metrics" },
      { stage: "modules", percent: 76, activityKey: "loader.activity.modules", activity: "Preparing dashboard modules" },
      { stage: "marketing", percent: 88, activityKey: "loader.activity.marketingConnected", activity: "Checking connected marketing data" },
      { stage: "rendering", percent: 98, activityKey: options.activityKey || "loader.activity.rendering", activityParams: options.activityParams, activity: options.activity || "Rendering dashboard content" },
    ].filter((checkpoint) => checkpoint.percent > state.percent);
    const stepMs = Number.isFinite(Number(options.stepMs)) ? Math.max(40, Number(options.stepMs)) : 85;
    const holdMs = Number.isFinite(Number(options.holdMs)) ? Math.max(40, Number(options.holdMs)) : 120;

    return new Promise((resolve) => {
      smoothCompletionResolve = resolve;
      function finish() {
        applyComplete(options);
        const timer = setTimeout(() => {
          if (smoothCompletionResolve === resolve) smoothCompletionResolve = null;
          resolve();
        }, holdMs);
        smoothTimers.push(timer);
      }
      function next(index) {
        ...
        const timer = setTimeout(() => {
          setStage(checkpoint.stage, {
            ...
            activityKey: checkpoint.activityKey,
            activityParams: checkpoint.activityParams,
  ...
  function setStage(stageId, options) {
    const stage = stages.find((item) => item.id === stageId) || stages[0];
    const index = stageIndex.get(stage.id) || 0;
    options = options || {};
    // A completed loader can be reused when the dashboard is reopened. Do not
    // carry its 100% stage values into the new run (for example, showing
    // "Marketing 100%" while a fresh marketing request is still pending).
    if (options.reset || state.complete) reset(options);
    state.currentStage = stage.id;
    state.complete = false;
    stages.forEach((item, itemIndex) => {
      if (itemIndex < index) state.stagePercents[item.id] = 100;
      else if (itemIndex > index) state.stagePercents[item.id] = Math.min(state.stagePercents[item.id] || 0, 0);
    });
    const target = options.percent != null ? options.percent : Math.max(state.percent, stage.start);
    motionTarget = Math.max(motionTarget, Number(options.percent != null ? options.percent : stage.end));
    state.percent = clampPercent(target, false);
    const stageSpan = Math.max(1, stage.end - stage.start);
    state.stagePercents[stage.id] = Math.max(
      state.stagePercents[stage.id] || 0,
      Math.min(98, ((state.percent - stage.start) / stageSpan) * 100)
    );
    setActivityState(options, stage.activityKey, stage.activity);
    updateDom();
    startMotion();
  }

  function setActivity(activity, percent) {
    if (activity) setActivityState(activity);
    if (percent != null) {
      motionTarget = Math.max(motionTarget, Number(percent) || motionTarget);
      state.percent = clampPercent(percent, false);
      const stage = stages.find((item) => item.id === state.currentStage) || stages[0];
      const stageSpan = Math.max(1, stage.end - stage.start);
      state.stagePercents[stage.id] = Math.max(
        state.stagePercents[stage.id] || 0,
  ...
  function complete(options) {
    options = options || {};
    if (options.smooth) return smoothComplete(options);
    clearSmoothCompletion();
    applyComplete(options);
  ...
  return {
    dashboardStage: setStage,
    dashboardActivity: setActivity,
    dashboardRefresh: function (options) {
      reset(options && options.activity);
    },
    dashboardComplete: complete,
  };
})();

// Dashboard modules historically call the Taager-named compatibility global.
// Keep both names pointed at the KHOD implementation while those internals are migrated.
window.TaagerPreloader = window.KhodPreloader;

window.addEventListener("khod-lang-change", () => {
  if (window.KhodPreloader && typeof window.KhodPreloader.dashboardActivity === "function") {
    window.KhodPreloader.dashboardActivity();
  }
});
...
function showPage(id) {
  ...
  KhodPerf.measure("route:" + id + ":click-to-visible", "route:" + id + ":click", "route:" + id + ":visible", { pageId: id });
...
function handleAdminNotificationResult(result) {
  if (window.KhodAdminNotifications && typeof window.KhodAdminNotifications.handle === "function") {
    window.KhodAdminNotifications.handle(result && result.adminNotification ? result.adminNotification : null);
  }
}
...
function startPeriodicLicenseCheck() {
  ...
  licenseCheckInterval = setInterval(async () => {
    ...
    try {
      ...
      updateTopBarText();
      handleAdminNotificationResult(lr);
...
function _triggerExpiredOverlay(reason) {
  handleAdminNotificationResult(null);
  ...
  window.showExpiredOverlay({
    ...
    onResume: (freshResult) => {
      ...
      handleAdminNotificationResult(freshResult);
...
function resolveAutoRunAccountIds(creds) {
  ...
  const allIds = accounts.filter(a => a && a.accountType !== "static").map(a => a.id);
...
let _autoRunTickInProgress = false;
async function runAutoRunTick(dateFrom, dateTo) {
  if (_autoRunTickInProgress) return;
...
async function init() {
  ...
  updateTopBarText();
  handleAdminNotificationResult(licenseResult);
...
async function refreshStartupStateFromServer() {
  ...
  try {
    ...
    updateTopBarText();
    handleAdminNotificationResult(freshLicense);
    ...
    if (window.KhodMonitoring) window.KhodMonitoring.captureException(e, { operation: "startup.backgroundRefresh" });
  }
}
...
function goToRun(dateFrom, dateTo, selectedAccountIds, runOptions) {
  if (window._teamLeaderEnabled || !(window._kbotAccounts || []).some(account => account && account.accountType !== "static")) {
    if (window._dashboardEnabled && typeof _onRunForDashboard === "function") {
      _onRunForDashboard(selectedAccountIds || [], { dateFrom, dateTo }, { stayOnDashboard: true }).catch((err) => {
        if (window.KhodMonitoring) window.KhodMonitoring.captureException(err, { operation: "dashboard.autorunFetch" });
...
async function _saveAnalyticsFromResult(data, selectedAccountIds) {
  ...
  function resolveAccountIdentity(result, fallbackId) {
    ...
    const country = (result?.khodCountry || result?.taagerCountry || result?.data?.khodCountry || result?.data?.taagerCountry || account?.khodCountry || account?.taagerCountry || "sa").toLowerCase();
    return {
      accountId,
  ...
  if (data._multiAccount && Array.isArray(data._accountResults)) {
    for (const r of data._accountResults) {
      ...
      const saveRes = await window.api.saveRunAnalytics({
        ...
        khodCountry:     identity.khodCountry,
        ...
        khodSnapshot:      r.data?.khodSnapshot || r.data?.taagerSnapshot || null,
  ...
  const saveRes = await window.api.saveRunAnalytics({
    ...
    khodSnapshot:      data.khodSnapshot || data.taagerSnapshot || null,
...
async function goToResults(data, dateFrom, dateTo, selectedAccountIds) {
  ...
  const onRunAgain = () => {
    ...
    goToRun(dateFrom, dateTo, selectedAccountIds, review);
  };
...
function _renderLockedPage(pageId, featureNameEn, featureNameAr) {
  ...
  document.getElementById(`${pageId}-support-btn`)?.addEventListener("click", () => {
    if (window.KhodSupport && typeof window.KhodSupport.open === "function") window.KhodSupport.open();
  });
}
...
async function goToDashboard() {
      ...
      if (typeof window.syncDashboardMarketingOnOpen === "function") {
        ...
        if (syncResult && typeof syncResult.then === "function") {
          syncResult.then(() => {
            ...
            KhodPerf.measure("route:page-dashboard:click-to-data-ready", "route:page-dashboard:click", "route:page-dashboard:data-ready", { pageId: "page-dashboard", remount: false });
          }).catch((err) => {
            if (window.KhodMonitoring) window.KhodMonitoring.captureException(err, { operation: "dashboard.reopenMarketingSync" });
          });
        }
      }
  ...
  // The dashboard owns its richer progress loader. Keep the current route in
  // place until that shell is mounted to avoid a generic-loader handoff.
  const dashboardStabilizationLock = beginUiStabilization("dashboard-route");
  const releaseDashboardStabilization = () => {
    waitForStableUi({ quietMs: 160, maxWaitMs: 1200 }).catch(() => {}).then(() => {
      endUiStabilization(dashboardStabilizationLock);
    });
  };
  try {
    if (window.KhodPreloader) window.KhodPreloader.dashboardStage("engine", { activity: "Loading dashboard engine" });
    await ensureFeatureScripts("dashboard");
    ...
    if (typeof window.ensureDashboardSection === "function") await window.ensureDashboardSection(initialDashboardSection);
    if (window.KhodPreloader) window.KhodPreloader.dashboardStage("snapshot", { activity: "Reading saved dashboard snapshots" });
    ...
    if (renderResult && typeof renderResult.then === "function") {
      window._dashboardInitialReady = renderResult;
    }
    ...
    const finishReady = () => {
      perfMark("route:page-dashboard:data-ready");
      KhodPerf.measure("route:page-dashboard:click-to-data-ready", "route:page-dashboard:click", "route:page-dashboard:data-ready", { pageId: "page-dashboard" });
      afterNextPaint(() => {
        if (window.preloadDashboardSectionResources) window.preloadDashboardSectionResources();
        if (window.prewarmDashboardCriticalSections) window.prewarmDashboardCriticalSections();
      });
    };
    if (renderResult && typeof renderResult.then === "function") {
      renderResult.then(finishReady).catch((err) => {
        if (window.KhodMonitoring) window.KhodMonitoring.captureException(err, { operation: "dashboard.initialReady" });
...
async function goToAiIntelligence() {
  if (!window._dashboardEnabled) {
    _renderLockedPage("page-ai-intelligence", "KHOD WHAAT AI", "KHOD WHAAT AI");
    showPage("page-ai-intelligence");
    return;
  }
  const token = nextFeatureRouteToken("ai-intelligence");
  perfMark("route:page-ai-intelligence:click");
  showFeatureLoadingPage("page-ai-intelligence", "KHOD WHAAT AI", "Loading AI intelligence...");
  showPage("page-ai-intelligence");
  try {
    await ensureFeatureScripts("dashboard");
    ...
    KhodPerf.measure("route:page-ai-intelligence:click-to-data-ready", "route:page-ai-intelligence:click", "route:page-ai-intelligence:data-ready", { pageId: "page-ai-intelligence" });
    ...
    if (isLatestFeatureRoute("ai-intelligence", token) && isActivePage("page-ai-intelligence")) showFeatureError("page-ai-intelligence", "KHOD WHAAT AI failed to load", err);
  }
}
...
function _renderDashboardStyleUpdateOverlay(state) {
  ...
  const ui = window.KhodUI || {};
  const esc = ui.esc ? ui.esc : (value) => String(value ?? "");
    ...
    overlay.innerHTML = `
      <div class="dashboard-update-panel" role="status">
        ...
        <div class="dashboard-update-copy">
          <strong>${esc(nextState.title || (ui.t ? ui.t("analytics.uploadedUpdate.loadingTitle", "Updating uploaded orders...") : "Updating uploaded orders..."))}</strong>
          <span>${esc(nextState.body || (ui.t ? ui.t("analytics.uploadedUpdate.loadingBody", "Fetching latest KHOD WHAAT statuses for uploaded orders in the selected range.") : "Fetching latest KHOD WHAAT statuses for uploaded orders in the selected range."))}</span>
        </div>
      </div>`;
  });
}
...
function _setDashboardFetchUi(state) {
  ...
  state = window._dashboardFetchState;
  ...
  uploadedBtns.forEach((uploadedBtn) => {
    ...
    uploadedBtn.disabled = !!window._dashboardFetchState.active;
    uploadedBtn.setAttribute("aria-busy", window._dashboardFetchState.active ? "true" : "false");
    uploadedBtn.innerHTML = window._dashboardFetchState.active
      ? `<span class="khod-spinner" aria-hidden="true"></span> ${KhodUI.esc(KhodUI.t("analytics.uploadedUpdate.loadingShort", "Updating..."))}`
  ...
  if (state.active) {
    ...
    status.innerHTML = `
      ...
      <div>
        ...
        <span>${KhodUI.esc(state.body || KhodUI.t("dashboard.fetching_body", "Fetching live KHOD WHAAT orders and refreshing saved dashboard data. This can take a few minutes; keep the app open."))}</span>
        ${detail ? `<span style="display:block;margin-top:6px;color:var(--text3);font-size:12px;direction:ltr;text-align:left;unicode-bidi:plaintext;">${KhodUI.esc(detail)}</span>` : ""}
      </div>
    `;
    return;
  }
...
async function _runDashboardUpdate(selectedAccountIds, period, options) {
  ...
  const accountLabels = new Map((window._kbotAccounts || window.dashboardAccountsList || []).map((acc) => [
    acc.id || acc.value,
    acc.memberName || acc.khodEmail || acc.email || acc.easyEmail || acc.easyStore || acc.storeName || acc.label || acc.name || acc.id || acc.value
  ]));
  ...
  _setDashboardFetchUi({
    ...
    body: KhodUI.t("dashboard.fetching_body", "Fetching live KHOD WHAAT orders and refreshing saved dashboard data. This may take a few minutes. Keep the app open.")
  });
  ...
  for (let i = 0; i < ids.length; i++) {
    ...
    try {
      ...
      if (fetchRes?.success) {
        ...
        failures.push({ accountId, label: accountLabels.get(accountId) || accountId, error: _dashboardFetchUserError(fetchRes?.error || "UNKNOWN_ERROR") });
  ...
  if (marketingStore && typeof marketingStore.sync === "function" && range?.dateFrom && range?.dateTo) {
    const roi = window.DashboardRoiState && typeof window.DashboardRoiState.get === "function"
      ...
      : {};
    const exchangeRates = window.KhodCurrency && typeof window.KhodCurrency.rates === "function"
      ? window.KhodCurrency.rates()
      : { USD: 1, SAR: 3.75, EGP: Number(roi.egpRate) || 52, AED: 3.6725, IQD: 1310, OMR: 0.385 };
    const marketingPayload = {
      dateFrom: range.dateFrom,
      dateTo: range.dateTo,
      targetCurrency: roi.currency || window.dashboardActiveCurrency || "SAR",
      exchangeRates,
      egpRate: Number(exchangeRates.EGP) || Number(roi.egpRate) || 52
    };
    try {
      _setDashboardFetchUi({
        active: true,
      ...
      if (window.KhodMonitoring) window.KhodMonitoring.captureException(error, {
  ...
  const warningParts = [];
  if (failures.length) warningParts.push(`KHOD WHAAT failed: ${failures.map(f => `${f.label || f.accountId}: ${f.error || "unknown error"}`).join(", ")}`);
  ...
  if (!anyLiveStageSucceeded) {
    const body = warningParts.join(". ") || KhodUI.t("dashboard.fetch_error_body", "Dashboard update failed.");
    _setDashboardFetchUi({
      kind: "error",
    ...
    KhodUI.toast(body, { kind: "error", timeout: 9000 });
  } else if (hasWarnings) {
...
async function _onUpdateUploadedOrdersForAnalytics(options) {
  options = options || {};
  if (!window._dashboardEnabled) {
    KhodUI.toast(KhodUI.t("dashboard.fetch_error_body", "Dashboard update is not enabled."), { kind: "error" });
    return { success: false, error: "DASHBOARD_NOT_ENABLED" };
  }
  let ids = Array.isArray(options.accountIds) ? options.accountIds.filter(Boolean) : [];
  if (!ids.length) {
    KhodUI.toast(KhodUI.t("analytics.uploadedUpdate.none", "No uploaded orders found in the selected range."), { kind: "info" });
  ...
  try {
    ...
    console.warn("[Analytics] Could not refresh account credentials before uploaded-orders update:", e.message);
  }
  ...
  if (window.api && typeof window.api.onDashboardLog === "function") {
    window.api.onDashboardLog(logHandler);
  } else if (window.api && typeof window.api.on === "function") {
    window.api.on("bot-dashboard-log", logHandler);
  }
  if (window.api && typeof window.api.onDashboardStage === "function") {
    window.api.onDashboardStage(stageHandler);
  } else if (window.api && typeof window.api.on === "function") {
    window.api.on("bot-dashboard-stage", stageHandler);
  }

  _setDashboardFetchUi({
    active: true,
    title: KhodUI.t("analytics.uploadedUpdate.loadingTitle", "Updating uploaded orders..."),
    body: KhodUI.t("analytics.uploadedUpdate.loadingBody", "Fetching latest KHOD WHAAT statuses for uploaded orders in the selected range.")
  });
  ...
  try {
    for (let i = 0; i < ids.length; i++) {
      ...
      try {
        ...
        if (fetchRes && fetchRes.success) {
          ...
          failures.push({ accountId, label, error: _dashboardFetchUserError(fetchRes?.error || "UNKNOWN_ERROR") });
        }
      } catch (error) {
        failures.push({ accountId, label, error: _dashboardFetchUserError(error.message || "UNKNOWN_ERROR") });
        if (window.KhodMonitoring) window.KhodMonitoring.captureException(error, {
          operation: "analytics.updateUploadedOrders.account",
          accountId,
        });
      }
    }
    ...
    if (window.invalidateDashboardCache) window.invalidateDashboardCache();
    invalidatePage("page-dashboard", "uploaded-orders-update");
    window.dispatchEvent(new CustomEvent("khod-analytics-runs-updated"));
    if (typeof options.onComplete === "function") await options.onComplete();

    if (successCount === 0) {
      const body = failures.map(f => `${f.label || f.accountId}: ${f.error || "unknown error"}`).join(". ") ||
        KhodUI.t("analytics.uploadedUpdate.errorBody", "Uploaded orders update failed.");
      _setDashboardFetchUi({
        kind: "error",
        title: KhodUI.t("analytics.uploadedUpdate.errorTitle", "Uploaded orders update failed"),
        body
      });
      KhodUI.toast(body, { kind: "error", timeout: 9000 });
      return { success: false, totalRows, successCount, failures };
    }

    if (failures.length) {
      const body = _fmtUi(
        "analytics.uploadedUpdate.partialBody",
        { count: totalRows, success: successCount, total: ids.length },
        `Updated ${totalRows} uploaded orders from ${successCount} of ${ids.length} account(s). Some accounts failed.`
      );
      _setDashboardFetchUi({
        kind: "error",
        title: KhodUI.t("analytics.uploadedUpdate.partialTitle", "Uploaded orders partially updated"),
        body
      });
      KhodUI.toast(body, { kind: "error", timeout: 9000 });
      return { success: true, partial: true, totalRows, successCount, failures };
    }

    const body = totalRows > 0
      ? _fmtUi("analytics.uploadedUpdate.successBody", { count: totalRows }, `Updated ${totalRows} uploaded orders. Status and revenue refreshed.`)
      : KhodUI.t("analytics.uploadedUpdate.noChanges", "Uploaded orders are already up to date.");
    _setDashboardFetchUi({
      kind: "success",
      title: KhodUI.t("analytics.uploadedUpdate.successTitle", "Uploaded orders updated"),
      body
    });
    KhodUI.toast(KhodUI.t("analytics.uploadedUpdate.successTitle", "Uploaded orders updated"), { kind: "success" });
    return { success: true, totalRows, successCount, failures };
  } finally {
    if (window.api && typeof window.api.removeAllListeners === "function") {
      window.api.removeAllListeners("bot-dashboard-log");
      window.api.removeAllListeners("bot-dashboard-stage");
...
async function reRenderCurrentPage(refreshToken) {
  const isCurrentLanguageRefresh = () => refreshToken == null || refreshToken === _languageRefreshToken;
  if (!isCurrentLanguageRefresh()) return;
  const active = document.querySelector(".page.active");
  if (!active) return;
  const id = active.id;
  if (id === "page-setup") {
    ...
    if (!isCurrentLanguageRefresh()) return;
    const dashboardMount = document.getElementById("db-shell-mount");
    const dashboardData = dashboardMount && dashboardMount._dashboardCurrentData;
    if (dashboardMount && dashboardData && typeof window.refreshDashboardShell === "function") {
      window.refreshDashboardShell(dashboardMount, dashboardData);
...
window.addEventListener("khod-analytics-runs-updated", () => {
  invalidatePage("page-analytics", "runs-updated");
  invalidatePage("page-operations", "runs-updated");
});

window.addEventListener("khod-product-names-change", () => {
