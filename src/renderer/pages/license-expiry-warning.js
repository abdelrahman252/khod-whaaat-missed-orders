(function () {
  ...
  // KHOD dispatches its own language event from the renderer shell.  Keeping
  // this listener brand-specific prevents the warning from staying in the
  // previous language after the user switches locales.
