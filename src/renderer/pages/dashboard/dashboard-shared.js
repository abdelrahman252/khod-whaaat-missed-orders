...
(function () {
  ...
  window.ICONS = {
    ...
    upload:
      '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">' +
      '<path d="M12 16V4"/><path d="m7 9 5-5 5 5"/><path d="M20 15v4a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-4"/></svg>',
    megaphone:
      '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">' +
      '<path d="M3 11v2a2 2 0 0 0 2 2h3l8 4V5l-8 4H5a2 2 0 0 0-2 2z"/>' +
      '<path d="M8 15l1.5 5H12l-1.5-5"/><path d="M19 9a4 4 0 0 1 0 6"/></svg>',
    wallet:
      '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">' +
  ...
  function activeDashboardCurrency() {
    return window.dashboardActiveCurrency || 'SAR';
  }
  ...
  window.kpiCard = function (opts) {
    ...
    var displayValue = opts.displayValue != null ? opts.displayValue : window.formatDashboardNumber(value, { decimals: decimals, compact: true });
    ...
    return '<div class="kpi-card dash-kpi-card" style="background:#0b1120;border:1px solid ' + accent + '35;' +
      ...
      '<div style="flex:1;display:flex;flex-direction:column;justify-content:center;align-items:center;padding:12px 0;">' +
        ...
        '<div class="dash-kpi-value" title="' + fullValue + (unit ? ' ' + unit : '') + '" style="font-size:' + numSize + ';font-weight:900;color:#fff;line-height:1;letter-spacing:0;' +
          ...
          '<span class="kpi-num" data-id="' + id + '" data-decimals="' + decimals + '" data-compact="true" data-to="' + value + '">' + displayValue + '</span>' +
        '</div>' +
        /* unit */
  ...
  window.runKpiAnimations = function (container) {
    ...
    els.forEach(function (el) {
      ...
      window.animateNumber(el, to, {
        duration: 520,
        decimals: Number(el.dataset.decimals || 0) || 0,
