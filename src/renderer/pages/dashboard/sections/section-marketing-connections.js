...
(function () {
  ...
  function marketingLoadingLabel() {
    return window.dashboardI18n && typeof window.dashboardI18n.t === 'function'
      ? (window.dashboardI18n.t('marketing.loading') || 'Loading')
      : 'Loading';
  }

  function marketingHydratedSkeleton() {
    return '<div class="dash-scroll" data-dashboard-hydrating="marketing" role="status" aria-live="polite" aria-label="' + marketingLoadingLabel() + '" ' +
