...
window.renderSectionCities = function (mountEl, data, ctx) {
  ...
  function mapHTML() {
    ...
    return (
      ...
      ' fill="' +
      ttText +
      '" font-size="10" font-weight="bold" font-family="Cairo,sans-serif"></text>' +
  ...
  function leaderboardHTML() {
    ...
    var rows = ALL_CITIES.map(function (c, i) {
      ...
      return (
        ...
        (120 + i * 40) +
        "ms;" +
        "display:grid;grid-template-columns:minmax(0, 1.5fr) minmax(0, 0.75fr) minmax(0, 0.75fr) minmax(0, 1fr) minmax(0, 0.6fr) minmax(0, 0.6fr);" +
    ...
    return (
      ...
      '<div style="display:grid;grid-template-columns:minmax(0, 1.5fr) minmax(0, 0.75fr) minmax(0, 0.75fr) minmax(0, 1fr) minmax(0, 0.6fr) minmax(0, 0.6fr);' +
  ...
  mountEl.querySelectorAll(".sc-dot-inner").forEach(function (el) {
    el.addEventListener("mouseenter", function () {
      ...
      if (ttName) {
        ttName.setAttribute("x", tx + 48);
        ttName.setAttribute("y", ty + 16);
