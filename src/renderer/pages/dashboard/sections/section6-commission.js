    ...
    return `
      <div class="s6-topbar" style="display:flex;align-items:center;justify-content:space-between;
        ...
        <div style="display:flex;gap:10px;">
          <button style="display:flex;align-items:center;gap:8px;padding:7px 14px;border-radius:10px;
            border:1px solid rgba(255,255,255,0.12);background:rgba(255,255,255,0.05);
            cursor:pointer;color:rgba(255,255,255,0.75);font-size:12px;font-weight:600;font-family:inherit;">
