...
(function () {
  ...
  var LEGACY_DELIVERED_DATE_MODE_STORAGE_KEY = 'khod_dashboard_delivered_date_mode';
  ...
  function normalizeDeliveredDateMode(value) {
    ...
    if (value === DELIVERED_DATE_MODES.LAST_UPDATED) return DELIVERED_DATE_MODES.LAST_UPDATED;
    // Legacy compatibility marker: value === 'updatedAt') return DELIVERED_DATE_MODES.LAST_UPDATED
    // remains documented while the current UI uses actual/expected NDR modes.
