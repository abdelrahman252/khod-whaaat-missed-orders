(function () {
  ...
  var AR_FALLBACKS = {
    ...
    'Earned marketer commission': 'العمولة المحققة',
    'Expected marketer commission': 'عمولة المسوق المتوقعة',
    'Lost marketer commission': 'عمولة المسوق المفقودة',
    'Marketer commission': 'عمولة المسوق',
    ...
    'Gap': 'الفجوة',
    'Products driving 80% of marketer commission': 'منتجات تحقق 80% من عمولة المسوق',
    'products': 'منتجات',
    'Active cities': 'المدن النشطة',
    'cities': 'مدن',
    'Marketer commission growth': 'نمو عمولة المسوق',
    'Delivered sales': 'المبيعات المسلمة',
    'vs previous period': 'مقارنة بالفترة السابقة',
    'Average daily marketer commission': 'متوسط عمولة المسوق اليومية',
    ...
    'Daily marketer commission trend': 'اتجاه عمولة المسوق اليومية',
    ...
    'Revenue': 'الإيرادات',
    'delivered × simulator marketer commission per delivered order': 'المسلم × عمولة المسوق في المحاكاة لكل طلب مسلم',
    ...
    'Marketer commission health': 'مؤشرات عمولة المسوق',
    'Total marketer commission': 'إجمالي عمولة المسوق',
    ...
    'Delivery Rate (NDR)': 'معدل التسليم (NDR)',
    'Simulator marketer commission / delivered order': 'عمولة المسوق في المحاكاة لكل طلب مسلم',
    ...
    'Simulator marketer commission': 'عمولة المسوق في المحاكاة',
    ...
    'MARKETER COMMISSION OPTIMIZATION': 'تحسين عمولة المسوق',
    ...
    'Returns are positive but tight. Use Section 7 to test NDR, simulator marketer commission, and budget scenarios.': 'العوائد إيجابية لكنها محدودة. استخدم القسم 7 لاختبار NDR وعمولة المسوق في المحاكاة وسيناريوهات الميزانية.',
    ...
    'Earned marketer commission = sum(marketer commission) for delivered orders.': 'العمولة المحققة = مجموع عمولة المسوق للطلبات المسلمة.',
    'Expected marketer commission = sum(marketer commission) for active non-delivered orders.': 'عمولة المسوق المتوقعة = مجموع عمولة المسوق للطلبات النشطة غير المسلمة.',
    'Lost marketer commission = sum(marketer commission) for failed and canceled orders, excluding Canceled by you.': 'عمولة المسوق المفقودة = مجموع عمولة المسوق للطلبات الفاشلة والملغاة، مع استبعاد الملغي بواسطتك.',
    ...
    'Maximum CPA before the campaign starts losing money. This simulator uses the editable marketer commission per delivered order assumption multiplied by NDR.': 'أقصى تكلفة طلب قبل أن تبدأ الحملة في خسارة المال. يستخدم هذا المحاكي افتراض عمولة المسوق القابلة للتعديل لكل طلب مسلم مضروبة في NDR.',
    ...
    'Actual earned marketer commission from delivered orders before subtracting synced ad spend.': 'عمولة المسوق المحققة فعليا من الطلبات المسلمة قبل طرح الإنفاق الإعلاني المتزامن.',
