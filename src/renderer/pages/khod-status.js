// KHOD WHAAT dashboard/status/NDR helper.
// Keep dashboard, analytics, operations, and AI status math routed through this
// file so Arabic KHOD WHAAT statuses, NDR, and profit stay consistent.
(function () {
  "use strict";
  ...
  function productName(row) {
    ...
    var saved = window.KhodProductNames && sku ? window.KhodProductNames.get(sku) : "";
  ...
  window.KhodStatus = {
    ...
    khodProfit: khodProfit,
    taagerProfit: khodProfit,
    profitAfterFees: khodProfit,
    productName: productName
  };

  // Dashboard/analytics modules share the historical status contract.
  // This alias keeps them on KHOD's status rules and localized labels.
  window.TaagerStatus = window.KhodStatus;
})();
