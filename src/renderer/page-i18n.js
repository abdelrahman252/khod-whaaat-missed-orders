(function () {
  ...
  function observePages() {
    if (!window.MutationObserver || window._khodPageI18nObserver) return;
    window._khodPageI18nObserver = new MutationObserver(function (mutations) {
      var roots = [];
    ...
    window._khodPageI18nObserver.observe(document.body, {
      childList: true,
      subtree: true,
      characterData: true,
      attributes: true,
