...
for (const surface of supportSurfaces) {
  assert(surface.includes("window.KhodSupport"), "Every support surface must use the shared helper");
...
assert(app.includes("window.KhodSupport"), "Feature-locked support button must use the shared helper");
