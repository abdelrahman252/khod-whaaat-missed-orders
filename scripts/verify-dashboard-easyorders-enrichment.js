...
assert.strictEqual(taagerKnownPayment.paymentClassification, "cod", "KHOD WHAAT payment column should win over EasyOrders");
assert.strictEqual(taagerKnownPayment.paymentEvidenceSource, "taager-payment-column", "KHOD WHAAT payment source should be preserved");
