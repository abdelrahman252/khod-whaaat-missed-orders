...
const cities = read("src/renderer/pages/dashboard/sections/section-cities.js") +
  "\n" + read("src/renderer/pages/dashboard/sections/section-cities-hydrated.js");
...
const s6 = read("src/renderer/pages/dashboard/sections/section6-commission.js") +
  "\n" + read("src/renderer/pages/dashboard/sections/section6-commission-hydrated.js");
...
ok("Chart.js dashboard animations are disabled", [s6, s7, s8].every((src) => src.includes("animation: false")));
